...
var Index = map[string]map[bool]string{
	...
	"compress/bzip2": {
		...
		true:  "8f76bf8199f0a6f0e963a278b50256de4ac8b87a",
	},
	"compress/flate": {
		false: "127cd44be88b1ed72f7e06ce0987b59b2b6251cd",
		true:  "2326c4b9a5105340a18ef14cec8636f099286328",
	},
	"compress/gzip": {
		false: "84e2383a2a31d12fa8c61c6e542e408b244d4d47",
		true:  "4d712f8567960a36a1f90221e899dc5124aad139",
	},
	"compress/lzw": {
		false: "07e450c48bce9478e1f2a59a509e1bd7ab557e69",
	...
	"crypto/hmac": {
		...
		true:  "906b9ea14281071f999a6c8b3797ae5bc886e3d6",
	},
	"crypto/internal/randutil": {
		false: "2582a9610a0edea56d0721bfba1154d65449a049",
		true:  "08784aa1adb49faeb6e45bcde4afe44dadd99630",
	},
	"crypto/internal/subtle": {
		false: "5163366fee633574e32e5a104f820021f82e5083",
	...
	"debug/gosym": {
		...
		true:  "d5e2cb10dbf5ad3017e43942ea1bb7bd2e65b55a",
	},
	"debug/macho": {
		false: "a5609770b32a59222189bad3894362267f21331f",
	...
	"debug/plan9obj": {
		...
		true:  "0dffb5503f03384021d02636d9670faf75618540",
	},
	"encoding": {
	...
	"encoding/ascii85": {
		false: "b26bdfc147943abda8ece6a5bfc76edda2932653",
		true:  "a2ff9a704103571570709ba7b6a79d19cdfd57fc",
	},
	"encoding/asn1": {
		false: "45b8e84ef3498cd74cda6c30757cbacdd74129d0",
		true:  "00a03c571727fb101f2f1d7acff4ee0e57ef9b92",
	},
	"encoding/base32": {
		false: "db12b666c15da11bc8fe9a280ca72a43ac21f388",
	...
	"encoding/csv": {
		...
		true:  "aa906d93fa8b07cb227225fab01970f9b955b7dc",
	},
	"encoding/gob": {
		false: "360db53511be652c633e3f33814ece18039b8136",
	...
	"github.com/gopherjs/gopherjs/js": {
		...
		true:  "052d6562f1801f3206accd7957dcf3c16e0d62dc",
	},
	"github.com/gopherjs/gopherjs/nosync": {
		false: "005650df700d7835da698c2eca12897873889552",
	...
	"go/internal/srcimporter": {
		...
		true:  "fd52ab4f2bc8f52610853ee4e08837c29196336c",
	},
	"go/parser": {
		false: "8a811388e3687a4d7d77702a544cf50f29f55b65",
	...
	"hash/crc32": {
		false: "b4f6285a2e3c2bab6051b446ff6ca599d413da67",
	...
	"image/color": {
		...
		true:  "efde565dd804d0a0d5a0020730306a4721c9b182",
	},
	"image/color/palette": {
	...
	"internal/singleflight": {
		false: "a7ef7616bca411987413afbe9f050844e085e22d",
	...
	"math/rand": {
		false: "fcedc447b67001351d1501c0bb6bda93e28eed8a",
	...
	"net/rpc": {
		...
		true:  "6369f696a2f89d6bf53c2df61522ee439a5b700e",
	},
	"net/rpc/jsonrpc": {
		false: "aa999fc2b0c4a0d4b5a17a9ac4b5dbbb934b58ec",
		true:  "bcccf5d7cacb762265865eec62819cddbdbffe19",
	},
	"net/smtp": {
		false: "62ad1e246773657b1c5755da78dd026a82b720c3",
	...
	"runtime/pprof": {
		false: "96adb211d7c69dd7594588f2a60ce3e8badb8079",
	...
	"runtime/trace": {
		false: "e0c3b13749152854b8b0006ad7530de4c6976a05",
		true:  "e90f47f813acc8186f45bb05343d6bbeaf8848df",
	},
	"sort": {
		false: "dfdeadcb61fa5cc4650e18b4d9ff83a7f467f937",
	...
	"testing/internal/testdeps": {
		...
		true:  "64c7647591bd1eba6b68573a60efe8cbb89e0fed",
	},
	"testing/iotest": {
		false: "03c445e252a5bb00e5763d331d6fe75e8a1b96ad",
		true:  "6f32a81a28fb988dd59cde6aed89b442e0a7beeb",
	},
	"testing/quick": {
		false: "85bc508d3cb6f4a0aa87275fc9105f4a5eba5496",
	...
	"unicode": {
		...
		true:  "703b1e6f7af8a8f4e0dd7bbf31cae164dd667973",
	},
	"unicode/utf16": {
	...
	"unicode/utf8": {
		false: "fcfeaf9f83b3d71d7322ae91413792f0e8530898",
		true:  "d7beb80cd54f3b382af915b4ba61a9893b4a7fb7",
	},
	"unsafe": {
